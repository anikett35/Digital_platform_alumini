...
const postValidation = [
  ...
  body('category').optional().isIn(['career', 'networking', 'advice', 'opportunities', 'events', 'general']).withMessage('Invalid category'),
  body('tags').optional().isString().withMessage('Tags must be a string of comma-separated values')
];
...
// FIXED: Removed duplicate DELETE route - had two router.delete('/:id', ...) entries
