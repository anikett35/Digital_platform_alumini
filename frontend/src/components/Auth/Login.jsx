      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="animate-fade-in-delay-4">
            <button
              type="button"
              className="w-full bg-white text-gray-800 py-3 px-6 rounded-xl font-semibold text-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all duration-300 flex items-center justify-center space-x-2 border border-gray-300 hover:shadow-lg"
            >
